    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('two_factor_auth_status', models.CharField(choices=[('A', 'تایید شده'), ('UA', 'تایید نشده')], default='UA', max_length=2, verbose_name='وضعیت احراز هویت دو مرحله\u200cای')),
                ('tfa_verified_at', models.DateTimeField(blank=True, null=True, verbose_name='زمان تایید احراز هویت دو مرحله\u200cای')),
                ...
                ('phone_verified', models.BooleanField(default=False, verbose_name='شماره تلفن تایید شده')),
